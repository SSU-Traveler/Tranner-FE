export type Indicator = { name: string; lat: number; lng: number };

// 각 광역자치단체의 위도, 경도
export const CITY_INDICATORS: Indicator[] = [
...
// 각 기초자치단체의 위도, 경도
// 서울
export const SEOUL_DISTRICT_INDICATORS: Indicator[] = [
...
// 경기
export const GYEONGGI_DISTRICT_INDICATORS: Indicator[] = [
  ...
  { name: '하남시', lat: 37.5393, lng: 127.2146 },
  { name: '광명시', lat: 37.4787, lng: 126.864 },
  { name: '군포시', lat: 37.3614, lng: 126.935 },
  ...
  { name: '구리시', lat: 37.5944, lng: 127.1296 },
  { name: '의왕시', lat: 37.3945, lng: 126.9707 },
  { name: '포천시', lat: 37.8946, lng: 127.2 },
  { name: '여주시', lat: 37.2983, lng: 127.637 },
  { name: '동두천시', lat: 37.9039, lng: 127.057 },
  { name: '과천시', lat: 37.4292, lng: 126.9879 },
];

// 인천
export const INCHEON_DISTRICT_INDICATORS: Indicator[] = [
...
// 강원
export const GANGWON_DISTRICT_INDICATORS: Indicator[] = [
...
// 대전
export const DAEJEON_DISTRICT_INDICATORS: Indicator[] = [
...
// 대구
export const DAEGU_DISTRICT_INDICATORS: Indicator[] = [
  ...
  { name: '군위군', lat: 36.2399, lng: 128.5723 },
];

// 세종
export const SEJONG_DISTRICT_INDICATORS: Indicator[] = [{ name: '세종특별자치시', lat: 36.4801, lng: 127.289 }];

// 충북
export const CHUNGBUK_DISTRICT_INDICATORS: Indicator[] = [
  ...
  { name: '증평군', lat: 36.785, lng: 127.581 },
  { name: '진천군', lat: 36.857, lng: 127.435 },
];

// 충남
export const CHUNGNAM_DISTRICT_INDICATORS: Indicator[] = [
...
// 광주
export const GWANGJU_DISTRICT_INDICATORS: Indicator[] = [
...
// 전북
export const JEONBUK_DISTRICT_INDICATORS: Indicator[] = [
...
// 전남
export const JEONNAM_DISTRICT_INDICATORS: Indicator[] = [
  ...
  { name: '장성군', lat: 35.3011, lng: 126.7842 },
...
// 부산
export const BUSAN_DISTRICT_INDICATORS: Indicator[] = [
...
// 울산
export const ULSAN_DISTRICT_INDICATORS: Indicator[] = [
  { name: '중구', lat: 35.5663, lng: 129.3337 },
...
// 경북
export const GYEONGBUK_DISTRICT_INDICATORS: Indicator[] = [
  ...
  { name: '영주시', lat: 36.8057, lng: 128.6236 },
  ...
  { name: '영덕군', lat: 36.4146, lng: 129.365 },
  { name: '영양군', lat: 36.6648, lng: 129.1125 },
  { name: '예천군', lat: 36.6543, lng: 128.3088 },
  { name: '울릉군', lat: 37.4846, lng: 130.9056 },
  { name: '울진군', lat: 36.9985, lng: 129.3997 },
  { name: '의성군', lat: 36.3524, lng: 128.697 },
  { name: '청도군', lat: 35.6475, lng: 128.736 },
  { name: '청송군', lat: 36.4364, lng: 129.0573 },
  { name: '칠곡군', lat: 35.9848, lng: 128.6895 },
];

// 경남
export const GYEONGNAM_DISTRICT_INDICATORS: Indicator[] = [
...
// 제주
export const JEJU_DISTRICT_INDICATORS: Indicator[] = [
  { name: '제주시', lat: 33.4996, lng: 126.5312 },
  { name: '서귀포시', lat: 33.2543, lng: 126.5609 },
];

export const KOREA_DISTRICT_INDICATORS: { [key: string]: Indicator[] } = {
  서울: SEOUL_DISTRICT_INDICATORS,
  경기: GYEONGGI_DISTRICT_INDICATORS,
  인천: INCHEON_DISTRICT_INDICATORS,
  강원: GANGWON_DISTRICT_INDICATORS,
  대전: DAEJEON_DISTRICT_INDICATORS,
  대구: DAEGU_DISTRICT_INDICATORS,
  세종: SEJONG_DISTRICT_INDICATORS,
  충북: CHUNGBUK_DISTRICT_INDICATORS,
  충남: CHUNGNAM_DISTRICT_INDICATORS,
  광주: GWANGJU_DISTRICT_INDICATORS,
  전북: JEONBUK_DISTRICT_INDICATORS,
  전남: JEONNAM_DISTRICT_INDICATORS,
  부산: BUSAN_DISTRICT_INDICATORS,
  울산: ULSAN_DISTRICT_INDICATORS,
  경북: GYEONGBUK_DISTRICT_INDICATORS,
  경남: GYEONGNAM_DISTRICT_INDICATORS,
  제주: JEJU_DISTRICT_INDICATORS,
};
